...
def fetch_unsplash_image(keyword: str):
    try:
        ...
        print(f"Unsplash fetch failed for '{keyword}': {e}")
    return None
...
def build_title_slide(prs, title, theme, keyword="abstract"):
    ...
    add_text(slide, title,
             Inches(0.8), Inches(1.8), Inches(11.5), Inches(3.0),
             Pt(48), RGBColor(0xFF, 0xFF, 0xFF),
             bold=True, align=PP_ALIGN.CENTER)

    # Subtitle
    add_text(slide, "Generated by SlideBot 🚀",
             Inches(0.8), Inches(6.0), Inches(11.5), Inches(0.7),
             Pt(18), RGBColor(0xFF, 0xFF, 0xFF),
...
def build_layout_a(prs, heading, bullets, theme, keyword):
    ...
    add_text(slide, heading,
             Inches(5.8), Inches(0.5), Inches(7.2), Inches(1.2),
    ...
    for bullet in bullets[:5]:
        add_rect(slide, Inches(5.8), top + Inches(0.15),
                 Inches(0.08), Inches(0.4), theme["accent"])
        add_text(slide, bullet,
                 Inches(6.1), top, Inches(6.9), Inches(0.7),
...
def build_layout_b(prs, heading, bullets, theme, keyword):
    ...
    # Heading
    add_text(slide, heading,
             Inches(0.8), Inches(3.3), Inches(11.5), Inches(1.0),
...
# ─── LAYOUT C — Card style bullets with right image ───────────────
def build_layout_c(prs, heading, bullets, theme, keyword):
    ...
    # Heading
    add_text(slide, heading,
             Inches(0.7), Inches(0.25), Inches(8.5), Inches(1.0),
             Pt(28), theme["heading_color"],
             bold=True, align=PP_ALIGN.LEFT)
    ...
    colors = [theme["accent"], theme["accent2"],
              theme["card_bg"], theme["accent"],
              theme["accent2"]]

    for i, bullet in enumerate(bullets[:5]):
        card_color = colors[i % len(colors)]
        add_rect(slide, Inches(0.5), top,
                Inches(8.7), Inches(0.78), card_color, radius=30000)
...
def build_layout_d(prs, heading, bullets, theme, keyword):
    ...
    add_text(slide, heading,
             Inches(1.0), Inches(0.8), Inches(11.0), Inches(1.5),
             Pt(34), RGBColor(0xFF, 0xFF, 0xFF),
             bold=True, align=PP_ALIGN.CENTER)

    # White divider
    add_rect(slide, Inches(4.0), Inches(2.5),
             Inches(5.0), Inches(0.06),
    ...
    for bullet in bullets[:4]:
        add_text(slide, f"• {bullet}",
                 Inches(1.5), top, Inches(10.0), Inches(0.75),
                 Pt(20), RGBColor(0xFF, 0xFF, 0xFF),
                 align=PP_ALIGN.CENTER)
        top += Inches(0.88)
...
def build_thankyou_slide(prs, theme):
    ...
    # Big circle accent
    add_rect(slide, Inches(5.16), Inches(1.5),
         Inches(3.0), Inches(3.0), theme["card_bg"], radius=50000)

    add_text(slide, "Thank You! 🙏",
             Inches(1.0), Inches(2.2), Inches(11.0), Inches(1.8),
             Pt(52), theme["title_color"],
             bold=True, align=PP_ALIGN.CENTER)

    add_text(slide, "Generated by SlideBot",
             Inches(1.0), Inches(4.5), Inches(11.0), Inches(0.6),
